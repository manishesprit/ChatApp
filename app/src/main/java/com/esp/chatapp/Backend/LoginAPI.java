...
//                                                false).show();
    ...
    private void parse(String response) {
        ...
        try {
            ...
            if (code == 0) {
                Pref.setValue(context, Config.PREF_USER_ID, jsonObject.getInt(Config.id));
                Pref.setValue(context, Config.PREF_NAME, jsonObject.getInt(Config.name));
                Pref.setValue(context, Config.PREF_USERNAME, jsonObject.getInt(Config.name));
