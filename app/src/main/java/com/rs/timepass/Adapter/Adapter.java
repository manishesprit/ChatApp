...
import com.rs.timepass.Backend.APIResponseListener;
import com.rs.timepass.TimePassApplication;
...
//													true).show();
			...
			TimePassApplication.getInstance().addToRequestQueue(apiReq,
					tag);
		} catch (Exception e) {
...
//												error.getMessage(), "OK", true);
	...
	public void doCancel(String tag) {
		try {
			TimePassApplication.getInstance().cancelPendingRequests(tag);
		} catch (Exception e) {
			Log.error("Exception", e);
		}
	}
	...
	public class ApiRequest extends StringRequest {
		...
		public Map<String, String> getHeaders() throws AuthFailureError {
			...
			headers.put("AUTH-KEY", Config.API_KEY);
