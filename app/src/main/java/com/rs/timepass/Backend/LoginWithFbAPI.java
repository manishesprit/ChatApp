...
public class LoginWithFbAPI {
    ...
    public LoginWithFbAPI(Context context, ResponseListener responseListener, UserBean userBean) {
        ...
        this.mParams = new HashMap<String, String>();
            ...
            Config.API_LOGIN = Config.HOST + Config.API_LOGIN_FB_JSON + Config.username + "=" + userBean.username + "&" + Config.fbid + "=" + userBean.fbid + "&" + Config.latlong + "=" + userBean.latlong + "&" + Config.udid + "=" + Utils.getDeviceID(context);
